...
public class UserMapper {
    ...
    // Mapper từ UserRegister (request) -> User entity
    ...
    // Mapper từ User entity -> UserRegisterResponse (response sau đăng ký)
    ...
    // Mapper User entity -> UserDTO (dùng cho các API khác)
...
//                .password(user.getPassword())
    ...
    public void UpdateUser(User user, UserUpdateDTO userUpdateDTO) {
        ...
        // Bỏ user.setEmail để bảo toàn email hiện tại
        // Nếu cần cập nhật email (trong trường hợp đặc biệt), kiểm tra null
