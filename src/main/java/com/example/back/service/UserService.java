...
public class UserService {
    ...
    public UserLoginResponse loginUser(UserLoginDTO userLoginDTO) {
        User user = userRepository.findByEmail(userLoginDTO.getEmail())
                .orElseThrow(() -> new AppException(ErrorCodes.USER_NAME_OR_PASSWORD_INCORRECT));
    ...
    public String updateUser(UserUpdateDTO userUpdateDTO){
        ...
        user.setPassword(passwordEncoder.encode(user.getPassword())); // sửa chỗ này
        userRepository.save(user);

        return jwtUntil.GenerateAccessToken(user);
    }
